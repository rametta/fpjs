...
const examples = [
  ...
  },
  {
    ...
    link:
      '/?script=const%20data%20%3D%20%7B%0A%20%20name%3A%20%27jason%27%2C%0A%20%20cool%3A%20true%2C%0A%20%20age%3A%2024%2C%0A%20%20cats%3A%20%5B%0A%20%20%20%20%7B%20name%3A%20%27fluffy%27%2C%20lives%3A%205%20%7D%2C%0A%20%20%20%20%7B%20name%3A%20%27sparklez%27%2C%20lives%3A%208%20%7D%2C%0A%20%20%5D%0A%7D%0A%0Aconst%20getFluffyLives%20%3D%20L.get(%5B%27cats%27%2C%200%2C%20%27lives%27%5D)%0A%0AgetFluffyLives(data)'
  },
  {
  ...
  },
  {
    ...
    link:
      '/?script=const%20Status%20%3D%20daggy.taggedSum(%27Status%27%2C%20%7B%0A%20%20Loading%3A%20%5B%5D%2C%0A%20%20Data%3A%20%5B%27data%27%5D%2C%0A%20%20Empty%3A%20%5B%5D%0A%7D)%0A%0Aconst%20pageLoad%20%3D%20Status.Data(%7B%20hello%3A%206%20%7D)%0A%0A%2F%2F%20pattern%20matching%0ApageLoad.cata(%7B%0A%20%20Loading%3A%20()%20%3D>%20%27Page%20loading...%27%2C%0A%20%20Empty%3A%20()%20%3D>%20%27No%20data%20to%20display...%27%2C%0A%20%20Data%3A%20data%20%3D>%20data.hello%0A%7D)'
  }
]
...
const shouldToggle = toggleSidebar => ev => ev.keyCode === 27 && toggleSidebar()

export const Sidebar = ({ toggleSidebar }) => {
  const toggle = shouldToggle(toggleSidebar)

  useEffect(() => {
    document.addEventListener('keydown', toggle, false)
    return () => document.removeEventListener('keydown', toggle, false)
  })
